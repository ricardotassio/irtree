...
class EnStemmer {
    ...
    private char[] b;
    private int start, /* offset into b */
            end, /* offset to end of stemmed word */
            j, k;
    ...
    public void add(char[] w, int wLen) {
        if (start + wLen >= b.length) {
            char[] new_b = new char[start + wLen + INC];
            for (int c = 0; c < start; c++) {
                new_b[c] = b[c];
            }
            b = new_b;
