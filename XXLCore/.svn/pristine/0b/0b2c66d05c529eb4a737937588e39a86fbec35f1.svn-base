...
public class Logger implements InvocationHandler {
	...
	public static void main(String args[]) {
		...
		System.out.println();
		Proxy logger = (Proxy) newInstance(new xxl.core.cursors.sources.Enumerator(10),"xxl.core.cursors.Cursor",System.out);
		...
		cursor = getCursorLogger(new xxl.core.cursors.sources.Enumerator(10),xxl.core.util.XXLSystem.NULL);
		while (cursor.hasNext())
			cursor.next();
		cursor.close();
	}
