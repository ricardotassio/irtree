 ...
 * </ul></p>
 *
 * <p><b>Note:</b> When overwriting a method from SecureDecoratorCursor 
 * there must always be a call to the super method.
 * 
...
public abstract class SecureDecoratorCursor implements Cursor {
	 ...
	 */
	public SecureDecoratorCursor(Iterator iterator) {
