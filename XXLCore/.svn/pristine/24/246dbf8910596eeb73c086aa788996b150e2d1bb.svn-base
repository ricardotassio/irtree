...
public class StatisticsRawAccess implements RawAccess {
	 ...
	 */
	public StatisticsRawAccess(RawAccess r,int partitions, double sdHistFactor, double tHistFactor) throws RawAccessError {
		this.r = r;
		resetCounter();
		resetCount = 0;
	 ...
	 * @exception RawAccessError a specialized RuntimeException
	 */
	public StatisticsRawAccess(RawAccess r) throws RawAccessError {
		this(r,50,1.3,1.1);
	}
	...
	public String toString() {
		return 
			RawAccessUtils.rawAccessInfo(this) + 
			"\nopen: "+openCalls+" close: "+closeCalls+" read: "+readCalls+" write: "+writeCalls+" number of counterresets: "+resetCount+"\n"+
