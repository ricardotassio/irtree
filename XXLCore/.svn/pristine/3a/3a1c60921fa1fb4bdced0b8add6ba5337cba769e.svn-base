...
/**
 * Estimates iteratively the average of given {@link java.lang.Number numerical data} without any error control.
 ...
 * The average itself is computed iteratively, i.e. the data is successively consumed and the current average
 ...
 * Aggregator aggregator = new Aggregator(
		...
		new Average()			// aggregate function
	);
 * <\code><\pre>
 * <br>
...
public class Average extends Function {
	...
	public Object invoke(Object average, Object next) {
		if (average == null) {
			count = 1;
			return new Double(((Number) next).doubleValue());
		} else {
