...
public class HybridKernelCDFAggregateFunction extends Function implements OnlineAggregation {
	...
	public Object invoke(
		Object old,
		Object next) { // next[0] = sample, next[1] = Double-Object with variance, next[2] = min , next[3] = max, next[4] = (Object[]) with jump points
		if (next == null)
			return null;
		if ((Object[]) (((Object[]) next)[0]) == null)
			return null;
		// if given next (Object[]) != null, all fields of the array are filled
		min = ((Double) ((Object[]) next)[2]).doubleValue();
		max = ((Double) ((Object[]) next)[3]).doubleValue();
		variance = ((Double) ((Object[]) next)[1]).doubleValue();
		sample = (Object[]) (((Object[]) next)[0]);
		cps = (Object[]) (((Object[]) next)[4]);
		if (hkse == null)
