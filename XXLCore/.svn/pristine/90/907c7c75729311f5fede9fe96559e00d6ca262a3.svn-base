 ...
 * {@link xxl.core.functions.DecoratorFunction DecoratorFunction} for Functions providing
 * meta data.
 * Functions inherited from this class are used to provide meta data infomation used for example by
 * {@link xxl.core.cursors.MetaDataCursor MetaDataCursors} by implementing
 * <code>Object getMetaData()</code> from the {@link xxl.core.util.MetaDataProvider MetaDataProvider-interface}.
 */
...
public abstract class MetaDataFunction extends DecoratorFunction implements MetaDataProvider{
	 ...
	 * @param function Function to decorate as {@link xxl.core.util.MetaDataProvider MetaDataProvider}
	 */
