...
/**
 * This class provides a logical OR predicate. The OR predicate
 * represents the disjunction of two predicates to a new predicate that
 * returns <tt>false</tt> if and only if both underlying predicates
 * return <tt>false</tt>.
 */
public class Or extends BinaryPredicate {

	/**
	 * Creates a new OR predicate that represents the disjunction of
	 ...
	 */
 	public Or (Predicate predicate0, Predicate predicate1) {
		super(predicate0, predicate1);
	}

	/**
	 * Returns <tt>false</tt> if and only if both underlying predicates
	 * return <tt>false</tt>, otherwise <tt>true</tt> is returned.
	 *
	 * @param arguments the arguments to the underlying predicates.
	 * @return <tt>false</tt> if and only if both underlying predicates
	 *         return <tt>false</tt>, otherwise <tt>true</tt>.
	 */
