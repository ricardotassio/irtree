...
public abstract class Tree {
	...
	*/
	...
	public void update (Object oldData, Object newData) {
		for (Cursor objects = query(descriptor(oldData)); objects.hasNext();)
	...
	public void update (Descriptor descriptor, Object newData) {
		for (Cursor objects = query(descriptor); objects.hasNext();)
	...
	public class Query implements Iterator {
		...
		*/
		...
		protected Iterator expand (final Candidate parent, final Node node) {
			...
			return new Mapper(node.entries(), node.descriptors(parent.descriptor()),
				new Function () {
