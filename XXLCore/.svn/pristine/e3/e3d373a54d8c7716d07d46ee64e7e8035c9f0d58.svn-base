...
public class RandomAccessFileQueue extends StreamQueue implements FIFOQueue {
	 ...
	 * <code>RandomAccessFileQueue((File) array[0], (Function) array[1], new Constant(0), new Constant(0))</code>.
	 *
	 * @see Function
	 */
	 ...
	 */
	public RandomAccessFileQueue(String filename, FilesystemOperations fso, Converter converter, Function inputBufferSize, Function outputBufferSize, Function newInputStream, Function newOutputStream) {
	 ...
	 *        output buffer.
	 */
	public RandomAccessFileQueue(String filename, Converter converter, Function inputBufferSize, Function outputBufferSize) {
	 ...
	 *        output buffer.
	 */
	public RandomAccessFileQueue(String filename, FilesystemOperations fso, Converter converter, Function inputBufferSize, Function outputBufferSize) {
	 ...
	 *        output buffer.
	 */
	public RandomAccessFileQueue(String filename, Converter converter, Function newObject, Function inputBufferSize, Function outputBufferSize) {
		this(filename, new UniformConverter(converter, newObject), inputBufferSize, outputBufferSize);
	}
	 ...
	 */
	public RandomAccessFileQueue(String filename, Function newObject, Function inputBufferSize, Function outputBufferSize) {
		this(filename, ConvertableConverter.DEFAULT_INSTANCE, newObject, inputBufferSize, outputBufferSize);
	}
	 ...
	 * @see ConvertableConverter#DEFAULT_INSTANCE
	 */
	public RandomAccessFileQueue(File file, Function newObject, Function inputBufferSize, Function outputBufferSize) {
		this(file.getPath(), ConvertableConverter.DEFAULT_INSTANCE, newObject, inputBufferSize, outputBufferSize);
		this.file = file;
	}
