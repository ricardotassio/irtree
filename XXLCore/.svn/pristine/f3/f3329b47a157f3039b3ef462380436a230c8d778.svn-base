...
public class ComparatorBasedEqual extends ComparatorPredicate {

	/**
	 * This instance can be used for getting a default instance of
	 * ComparatorBasedEqual. It is similar to the <i>Singleton Design Pattern</i> (for
	 ...
	 * other instances of ComparatorBasesPredicate.
	 */
	public static final ComparatorBasedEqual DEFAULT_INSTANCE = new ComparatorBasedEqual();

	/**
	 * Creates a new binary predicate that determines whether the first
	 * given argument equals the second. Both arguments must
	 * implement the <tt>Comparable</tt> interface.
	 */
	public ComparatorBasedEqual () {}
	 ...
	 *        comparing objects.
	 */
	public ComparatorBasedEqual (Comparator comparator) {
		super(comparator);
	}

	/**
	 * Returns <tt>true</tt> if the <tt>argument0</tt> equals
	 * <tt>argument1</tt>.
	 *
	 * @param argument0 the first argument to the predicate.
	 * @param argument1 the second argument to the predicate.
	 * @return <tt>true</tt> if the <tt>argument0</tt> equals
