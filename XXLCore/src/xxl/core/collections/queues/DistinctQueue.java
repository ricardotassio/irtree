 ...
 *     // 100)
 * 
 *     Cursor cursor = new RandomIntegers(2, 10000);
 * 
 ...
 *		
 *     Queue q2 = new DistinctQueue(new ListQueue());
 *
 *     // opent the queue
 *
 *     q2.open();
...
public class DistinctQueue extends DecoratorQueue {
	 ...
	 * parameters. An array (<i>parameter list</i>) of queues will be used
	 ...
	 *         method is called.
	 */
	public void enqueue(Object object) throws IllegalStateException {
	...
	public static void main(String[] args) {
		...
		// create an iteration over 10000 random Integers (between 0 and
		// 100)
		xxl.core.cursors.Cursor cursor = new xxl.core.cursors.sources.RandomIntegers(2, 10000);
		// insert all elements of the given cursor
		for (; cursor.hasNext(); q1.enqueue(cursor.next()));
		// print the size of the queue after insertion
		System.out.println("Size q1:\t" + q1.size());
