 ...
 * {@link xxl.core.cursors.SecureDecoratorCursor} by additionally implementing the
 * interface {@link xxl.core.util.MetaDataProvider}. For getting a concrete
 * instance of this abstract class the method {@link #getMetaData() getMetaData}
 * has to be overwritten such that it returns the metadata information for the
 * decorated cursor.
 * 
...
public abstract class AbstractMetaDataCursor extends SecureDecoratorCursor implements MetaDataCursor {
	...
	/**
	 * Creates a new abstract metadata-cursor. The given iteration is wrapped to
	 * a cursor by calling the method
	 ...
	 */
	public AbstractMetaDataCursor(Iterator iterator) {
		super(iterator);
	}
