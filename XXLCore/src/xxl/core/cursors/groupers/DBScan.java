 ...
 *                 final AbstractIntervalND rect = (AbstractIntervalND)descriptor;
 *                 
 *                 // define a simple range query: iterating over all elements
 *                 // and checking if the given point is contained in the search
 *                 // rectangle
 * 
 *                 return data.query(
 *                     new Predicate() {
 *                         public boolean invoke(Object o) {
 *                             return rect.contains((Object[])((ClassifiableObject)o).getObject());
 *                         }
 *                     }
 *                 );
 *             }
 ...
 *                 Double[] o = (Double[])((ClassifiableObject)object).getObject();
 *                 
 *                 // defining a rectangle used as descriptor for range queries
 *                 
 *                 Double x1 = o[0];
 *                 Double x2 = new Double(o[0].doubleValue()+((Double)eps).doubleValue());
 *                 Double y1 = o[1];
 *                 Double y2 = new Double(o[1].doubleValue()+((Double)eps).doubleValue());
 *                 return new AbstractIntervalND(
 *                     new AbstractInterval1D[] {
 *                         new AbstractInterval1D(x1, x2),
 *                         new AbstractInterval1D(y1, y2)
 *                     }
 *                 );
 *             }
 *         }
 ...
 *     clusterCursor.open();
 * 
 *     //processing the DBScan cursor
 * 
 *     for (int i = 0; clusterCursor.hasNext(); i++) {
 * 
 *         // each element of the clusterCursor is a new cursor, namely a new cluster
 * 
 *         Cursor next = (Cursor)clusterCursor.next();
 ...
 *                         Double[] d = (Double[])((ClassifiableObject)o).getObject();
...
public class DBScan extends AbstractCursor {
	...
	/**
	 * A distance function delivering a double value for two given elements.
	 */
	 ...
	 */
	public static Predicate isUnclassified = new Predicate() {
		public boolean invoke(Object o) {
	 ...
	 * is marked as noise.
	 */
	public static Predicate isNoise = new Predicate() {
		public boolean invoke(Object o) {
	 ...
	 */
	public DBScan(Iterator input, double eps, int minPts, Distance distance, Function rangeQuery, Function getDescriptor, Function newQueue, Function newNoiseQueue, Function newChangedCIDQueue) throws IllegalArgumentException {
		if (eps < 0)
	 ...
	 *         <tt>minPts</tt> has been specified.
	 */
	public DBScan(Iterator input, double eps, int minPts, Distance distance, Function rangeQuery, Function getDescriptor) throws IllegalArgumentException {
		this(input, eps, minPts, distance, rangeQuery, getDescriptor, StackQueue.FACTORY_METHOD, ListQueue.FACTORY_METHOD, FIFOQueue.FACTORY_METHOD);
	}
	...
	public static void main(String[] args) {
		...
		data.insert(new ClassifiableObject(new Double[] {new Double(1.0), new Double(1.0)}));
		data.insert(new ClassifiableObject(new Double[] {new Double(2.0), new Double(1.0)}));
		data.insert(new ClassifiableObject(new Double[] {new Double(3.0), new Double(1.0)}));

		data.insert(new ClassifiableObject(new Double[] {new Double(1.0), new Double(2.0)}));
		data.insert(new ClassifiableObject(new Double[] {new Double(2.0), new Double(2.0)}));
		data.insert(new ClassifiableObject(new Double[] {new Double(2.0), new Double(2.0)}));
		data.insert(new ClassifiableObject(new Double[] {new Double(2.0), new Double(2.0)}));
		data.insert(new ClassifiableObject(new Double[] {new Double(2.0), new Double(2.0)}));
		data.insert(new ClassifiableObject(new Double[] {new Double(3.0), new Double(2.0)}));
		data.insert(new ClassifiableObject(new Double[] {new Double(3.0), new Double(2.0)}));

		data.insert(new ClassifiableObject(new Double[] {new Double(2.0), new Double(8.0)}));

		data.insert(new ClassifiableObject(new Double[] {new Double(1.0), new Double(3.0)}));
		data.insert(new ClassifiableObject(new Double[] {new Double(2.0), new Double(3.0)}));
		data.insert(new ClassifiableObject(new Double[] {new Double(3.0), new Double(3.0)}));

		data.insert(new ClassifiableObject(new Double[] {new Double(4.0), new Double(4.0)}));
		data.insert(new ClassifiableObject(new Double[] {new Double(5.0), new Double(5.0)}));
		data.insert(new ClassifiableObject(new Double[] {new Double(6.0), new Double(6.0)}));
		data.insert(new ClassifiableObject(new Double[] {new Double(7.0), new Double(7.0)}));
		data.insert(new ClassifiableObject(new Double[] {new Double(8.0), new Double(8.0)}));
		data.insert(new ClassifiableObject(new Double[] {new Double(9.0), new Double(9.0)}));

		data.insert(new ClassifiableObject(new Double[] {new Double(1.0), new Double(6.0)}));
		data.insert(new ClassifiableObject(new Double[] {new Double(1.0), new Double(7.0)}));
		data.insert(new ClassifiableObject(new Double[] {new Double(1.0), new Double(8.0)}));
		data.insert(new ClassifiableObject(new Double[] {new Double(1.0), new Double(9.0)}));

		data.insert(new ClassifiableObject(new Double[] {new Double(2.0), new Double(7.0)}));
		data.insert(new ClassifiableObject(new Double[] {new Double(2.0), new Double(7.0)}));
		data.insert(new ClassifiableObject(new Double[] {new Double(2.0), new Double(7.0)}));
		data.insert(new ClassifiableObject(new Double[] {new Double(2.0), new Double(7.0)}));
		data.insert(new ClassifiableObject(new Double[] {new Double(2.0), new Double(7.0)}));
		...
		data.insert(new ClassifiableObject(new Double[] {new Double(2.0), new Double(8.0)}));
		data.insert(new ClassifiableObject(new Double[] {new Double(2.0), new Double(9.0)}));

		data.insert(new ClassifiableObject(new Double[] {new Double(3.0), new Double(9.0)}));

		data.insert(new ClassifiableObject(new Double[] {new Double(5.0), new Double(9.0)}));
		data.insert(new ClassifiableObject(new Double[] {new Double(9.0), new Double(4.0)}));
		data.insert(new ClassifiableObject(new Double[] {new Double(8.0), new Double(1.0)}));

		/*
		data.insert(new ClassifiableObject(new Double[] {new Double(4.0), new Double(4.0)}));
		data.insert(new ClassifiableObject(new Double[] {new Double(0.0), new Double(0.0)}));
		data.insert(new ClassifiableObject(new Double[] {new Double(1.0), new Double(1.0)}));
		data.insert(new ClassifiableObject(new Double[] {new Double(1.0), new Double(1.0)}));
		...
		*/
		...
		DBScan clusterCursor = new DBScan(
			...
			new Function() {
				public Object invoke(Object descriptor) {
					final xxl.core.util.IntervalND rect = (xxl.core.util.IntervalND)descriptor;
					return data.query(  // define a simple range query: iterating over all elements
						new Predicate() { // and checking if the given point is contained in the search rectangle
							public boolean invoke(Object o) {
								return rect.contains((Object[])((ClassifiableObject)o).getObject());
							}
						}
			...
			new Function() {
				public Object invoke(Object object, Object eps) {
					Double[] o = (Double[])((ClassifiableObject)object).getObject();
					// defining a rectangle used as descriptor for range queries
					Double x1 = o[0], x2 = new Double(o[0].doubleValue()+((Double)eps).doubleValue());
					Double y1 = o[1], y2 = new Double(o[1].doubleValue()+((Double)eps).doubleValue());
					return new xxl.core.util.IntervalND(new xxl.core.util.Interval1D[]{
						new xxl.core.util.Interval1D(x1, x2),
						new xxl.core.util.Interval1D(y1, y2)}
					);
				}
			}
		);
