...
public class MultiDiskBTree extends BTree {
	 ...
	 */
	protected Function multiDiskGetContainer = new Function () {
	 ...
	 */
	protected Function multiDiskDetermineContainer = new Function () {
					...
					for (int i=0; i<2; i++) {
						...
						Cursors.forEach(
							new Taker(
								new Sequentializer(
									new Mapper(
										new Inductor(new Object[]{parentNode},
											new Function () {
