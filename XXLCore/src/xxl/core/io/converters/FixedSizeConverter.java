...
/**
 * This abstract class is a special kind of Converter which serializes 
 * each objects to the same number of bytes.
 * This class has the additional method getSize which has to
...
public abstract class FixedSizeConverter extends SizeConverter {
	...
	/**
	 * Constructs a converter which always converts its objects to
	 * size bytes.
