...
public class Aggregators {
	...
	public static Aggregator getNKDEAggregator(
		...
		return new Aggregator(
			new Aggregator(input, new Function[] { mapSamplingStrategy(sampleSize, samplingType), new Variance()}),
	...
	public static Aggregator getReservoirBasedKernelEstimatorAggregator(
		Iterator input,
		Function kernelBasedAggregateFunction,
		int sampleSize,
		int samplingType)
		throws IllegalArgumentException {
	 ...
	 */
	public static Function mapSamplingStrategy(int sampleSize, int type) throws IllegalArgumentException {
