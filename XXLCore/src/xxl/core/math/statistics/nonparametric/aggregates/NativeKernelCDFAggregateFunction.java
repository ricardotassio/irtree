 ...
 */
public class NativeKernelCDFAggregateFunction extends Function implements OnlineAggregation {
	...
	public Object invoke(
		Object old,
		Object next) { // next[0] = sample, next[1] = Double-Object with variance
		if (next == null)
			return null;
