...
public class RKDEAggregateFunction extends Function implements OnlineAggregation {
	...
	public Object invoke(
		Object old,
		Object next) { // next[0] = sample, next[1] = Double-Object with variance, next[2] = min , next[3] = max
		if (next == null)
			return null;
