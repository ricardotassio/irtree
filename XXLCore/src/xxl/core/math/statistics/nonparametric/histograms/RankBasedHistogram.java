...
public class RankBasedHistogram implements PointQuery {
	...
	public static void main(String[] args) {
		...
		List data = Cursors.toList(new RandomIntegers(10, 500));
		System.out.println("\nused cfd");
		Iterator debug =
		...
		RankBasedHistogram control = new RankBasedHistogram(data.iterator(), new Cfd());

		/*********************************************************************/
		/*                            Example 1                              */
		/*********************************************************************/
		RankBasedHistogram histogram = new RankBasedHistogram(data.iterator(), new MaxBased(4));
		...
		/*********************************************************************/
		//
		RankBasedHistogram histogram2 = new RankBasedHistogram(data.iterator(), new OptimizedMaxBased(4));
		...
		/*********************************************************************/
		//
		RankBasedHistogram histogram3 = new RankBasedHistogram(data.iterator(), new MaxDiff(4));
