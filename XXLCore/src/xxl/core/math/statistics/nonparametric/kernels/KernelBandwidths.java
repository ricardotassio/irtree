...
public class KernelBandwidths {
	...
	public static void main(String[] args) {
		...
		/*                            Example 1                              */
		/*********************************************************************/
		List entirety = new ArrayList();
		entirety.add(new double[] { 0, 1 });
		entirety.add(new double[] { 0, 1 });
		entirety.add(new double[] { 4, 5 });
		entirety.add(new double[] { 4, 6 });
		entirety.add(new double[] { 4, 7 });
		entirety.add(new double[] { 2, 9 });
		entirety.add(new double[] { 2, 4 });
		entirety.add(new double[] { 7, 2 });
		entirety.add(new double[] { 8, 0 });
		entirety.add(new double[] { 9, 4 });
		entirety.add(new double[] { 7, 6 });
		entirety.add(new double[] { 7, 6 });
		entirety.add(new double[] { 8, 6 });
		entirety.add(new double[] { 3, 9 });
		entirety.add(new double[] { 9, 3 });
		entirety.add(new double[] { 0, 9 });
		entirety.add(new double[] { 1, 8 });
		entirety.add(new double[] { 1, 4 });
		entirety.add(new double[] { 4, 0 });
		entirety.add(new double[] { 3, 4 });
		// drawing sample
		...
		for (int i = 0; i < sample.length; i++) {
			System.out.println(Strings.toString((double[]) sample[i]));
		}
		System.out.println("---------------------------------");
		// computing bandwidth for the sample
		int quantil = 3;
		double[] b = 
			KernelBandwidths.adaBand(
				sample, 
				entirety.iterator(), 
				new Distance() {
					public double distance(Object o1, Object o2) {
						return xxl.core.math.Maths.pDistance((double[]) o1, (double[]) o2, 2);
					}
				}, 
				quantil
			);
		// output
		System.out.println("ADABAND-bandwidth to quantil=" + quantil + ":");
