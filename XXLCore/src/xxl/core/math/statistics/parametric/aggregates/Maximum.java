...
/**
 * Computes the maximum of given data without any error control wrt.&nbsp;to a given ordering imposed
 ...
 * <br>
 * Objects of this class don't use any internally stored information to obtain the maximum, 
...
public class Maximum extends Function {
	 ...
	 */
	public Object invoke(Object max, Object next) {
		return max == null ? next : next == null ? max : Maths.max(max, next, comparator);
	}
