 ...
 *    <td width="39%"><b>Average number of uniform random variates</b></td>
 *    <td width="47%"><b>Average CPU time </b></td>
 *  </tr>
 *  <tr>
 *    <td width="14%">R</td>
 *    <td width="39%">N-n</td>
 ...
 * <code><pre>
 *  Iterator it = new Aggregator( new RandomIntegers (100,50), new ReservoirSample ( 10, new XType(10))  );
	while ( it.hasNext() ){
...
public class ReservoirSample extends Function {
	 ...
	 * @throws IllegalArgumentException if the size of the reservoir isn't at least 1
	 */
	public ReservoirSample(Object[] reservoir, ReservoirSamplingStrategy strategy) throws IllegalArgumentException {
	 ...
	 */
	public Object invoke(Object oldReservoir, Object next) {
		if (!initialized) {
