...
/**
 * Computes an estimation of the standard deviation step-by-step on 
 * {@link java.lang.Number numerical data} without any error control
 * using {@link xxl.core.math.statistics.parametric.aggregates.VarianceEstimator}.
 * <br>
...
public class StandardDeviationEstimator extends Function {
	 ...
	 * Objects of this type have a two-step phase for initialization.
	 * @param stddev the result of the aggregation function in the previous computation step
	...
	public static void main(String[] args) {
		...
		Aggregator aggregator1 = 
			new Aggregator(
				...
				new StandardDeviationEstimator() // aggregate function
			);
		System.out.println(
