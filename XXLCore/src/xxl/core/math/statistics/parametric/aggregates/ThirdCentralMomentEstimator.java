...
public class ThirdCentralMomentEstimator extends Function {
	...
	public static void main(String[] args) {
		...
		System.out.println(
			"The result of the 3rd central moment aggregation of 100 randomly distributed integers is: "
				+ aggregator1.last());
		aggregator1.close();
		...
		System.out.println(
			"\nThe result of the 3rd central moment aggregation of the natural numbers from 1 to 100 is: "
				+ aggregator2.last());
		aggregator2.close();
		...
		Aggregator aggregator3 =
			new Aggregator(
				new ShuffleCursor(
					Inductors.naturalNumbers(1, 100), // the input-Cursor
		...
		System.out.println(
			"\nThe result of the 3rd central moment aggregation of the natural numbers (shuffled) from 1 to 100 is: "
				+ aggregator3.last());
		aggregator3.close();
	}
}