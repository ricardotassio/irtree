...
public class LessEqual extends Or {
	 ...
	 * creation of other instances of LessEqual.
	 */
	 ...
	 * given argument is less than or equal to the second. Both
	...
	/**
	 * Creates a new binary predicate that determines whether the first
	 * given argument is less than or equal to the second.
	 *
