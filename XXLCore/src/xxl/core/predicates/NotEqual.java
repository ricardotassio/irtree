 ...
 * method of the class {@link Object}. In other words, two arguments
 * <tt>a</tt> and <tt>b</tt> are not equal when (<tt>a==null && b!=null</tt>)
 * or (<tt>a!=null && !a.equals(b)==true</tt>) is true.
 * In case that a comparator has been specified, it precedes equals.
 */
public class NotEqual extends Predicate {

	/**
	 * This instance can be used for getting a default instance of
	 * NotEqual. It is similar to the <i>Singleton Design Pattern</i> (for
	...
	/**
	 * Returns whether the given arguments are equal or not. In other
	 * words, returns <tt>true</tt> if the first arguments is <tt>null</tt>
	 * and the second isn't or if <tt>!argument0.equals(argument1)</tt>
	 * returns <tt>true</tt>. The exact implementation is
	 * <pre>
