...
public class PlaneSweep extends SortMergeJoin {
	...
	public static class KPEPlaneSweepComparator implements Comparator{
		...
		*/
		public int compare(Object object1, Object object2){
			double left  =  ((Rectangle)((KPE)object1).getData()).getCorner(upper).getValue(dim);
			double right =  ((Rectangle)((KPE)object2).getData()).getCorner(upper).getValue(dim);
	...
	public static void main(String[] args) {
		...
		final Function newObject = new Function(){
		...
		final Function newQueue = new Function(){
			...
			public Object invoke (Object inputBufferSize, Object outputBufferSize){
				if(external){
					...
					return new RandomAccessFileQueue(file, newObject,
		...
		final Comparator comparator = KPEPlaneSweepComparator.DEFAULT_INSTANCE;
