...
/* ------------------------------------------------------------------- */
	...
	*/
	...
	public static void main ( String [] args) {
		...
		Iterator it = realGrid ( new double [] { -1.0, 2.0}, new double [] { 4.0, 3.0}, new int [] { 6, 4});
		while ( it.hasNext()){
		...
		it = realGrid ( new double [] { -1.0, 2.0}, new double [] { 4.0, 3.0}, 4);
		while ( it.hasNext()){
			System.out.println( Strings.toString ( (double []) it.next()));
		}
		System.out.println("- end -");
